package com.github.bakerzhu.agent.example.fieldadd;
...
public class AddField extends ClassVisitor {
    ...
    public static void main(String[] args) throws Exception {
        String output = System.getProperty("user.dir") + "/target/classes/com/github/bakerzhu/";
        String classDir = System.getProperty("user.dir") + "/target/classes/com/github/bakerzhu/App.class";
        ClassReader classReader = new ClassReader(new FileInputStream(classDir));
        ClassWriter classWriter = new ClassWriter(classReader,ClassWriter.COMPUTE_MAXS);
        ClassVisitor addField = new AddField(classWriter,"field",
        ...
        File newFile = new File(output,"App1.class");
